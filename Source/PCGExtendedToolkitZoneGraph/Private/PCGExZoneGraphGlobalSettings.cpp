...
TArray<PCGEx::FPinInfos> UPCGExZoneGraphGlobalSettings::InPinInfos;
TArray<PCGEx::FPinInfos> UPCGExZoneGraphGlobalSettings::OutPinInfos;
TMap<FName, int32> UPCGExZoneGraphGlobalSettings::InPinInfosMap;
TMap<FName, int32> UPCGExZoneGraphGlobalSettings::OutPinInfosMap;
bool UPCGExZoneGraphGlobalSettings::bGeneratedPinMap = false; // Initialize to a default value

FLinearColor UPCGExZoneGraphGlobalSettings::WantsColor(const FLinearColor InColor) const
{
	return bUseNativeColorsIfPossible ? FLinearColor::White : InColor;
}

bool UPCGExZoneGraphGlobalSettings::GetPinExtraIcon(const UPCGPin* InPin, FName& OutExtraIcon, FText& OutTooltip, bool bIsOutPin) const
{
#if WITH_EDITOR

	if (!bGeneratedPinMap)
	{
		UPCGExZoneGraphGlobalSettings* This = const_cast<UPCGExZoneGraphGlobalSettings*>(this);
...
void UPCGExZoneGraphGlobalSettings::GeneratePinInfos()
{
#if WITH_EDITOR
